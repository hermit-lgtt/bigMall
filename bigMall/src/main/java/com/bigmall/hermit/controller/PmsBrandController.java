...
import com.bigmall.hermit.common.api.CommonPage;
...
public class PmsBrandController {
    ...
    @ResponseBody
    public CommonResult<CommonPage<PmsBrand>> list(@RequestParam(value = "pageNum",defaultValue = "1") @ApiParam("页码") Integer pageNum,
        ...
        return CommonResult.success(CommonPage.commonPage(brandList));
    }
